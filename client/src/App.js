...
const AccentureLogo = ({ dark = false }) => (
  <div style={{ display: 'flex', alignItems: 'center', gap: 7 }}>
    <svg width="28" height="22" viewBox="0 0 28 22" fill="none" xmlns="http://www.w3.org/2000/svg">
      {/* Accenture's actual mark: a solid right-pointing chevron ">" */}
      <path d="M2 1 L18 11 L2 21" stroke="#A100FF" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" fill="none"/>
    </svg>
    <span style={{
      fontSize: 15, fontWeight: 700,
      color: dark ? '#fff' : '#A100FF',
      letterSpacing: '-0.2px',
